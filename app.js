...
// SSR
// Route to render index.html with inventories using EJS
app.get("/", blogSSR.renderInventories);
...
// API
// GET all Inventories
app.get("/api/inventories", blogAPI.getInventories);
// POST a new Inventory
app.post("/api/inventories", blogAPI.addInventory);
// GET a single Inventory
app.get("/api/inventories/:id", blogAPI.getInventory);
// Update Inventory using PUT
app.put("/api/inventories/:id", blogAPI.updateInventory);
// DELETE a Inventory
app.delete("/api/inventories/:id", blogAPI.deleteInventory);
// DELETE all Inventory
app.delete("/api/inventories", blogAPI.deleteAllInventories);
